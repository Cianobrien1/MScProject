########################################################################################################################
# This script uses O3A alignment to align the RDKit 2023 SMILE derived conformers with MMFF forcefield generation to   #
# the openbabel pqbt derived crystal poses, saving the conformer with the lowest RMSD vs their respective crystal pose #
# to a pdb file.                                                                                                       #
########################################################################################################################
...
# Path to directories
test_sample_dir = "/home/s2451611/MScProject/Conformers/rdkit_2023_MMFF_conformer_dir"
crystal_dir = "/home/s2451611/MScProject/openbabel_sdf_crystal_pose_ligands_for_MMFF_confs "
